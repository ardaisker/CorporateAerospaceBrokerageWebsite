...
const translations = {
  en: {
    ...
    'hero.eyebrow': 'Aerospace · Aviation · Defense',
    'hero.cta2': 'Request a quote',
    'hero.credentials': 'Working to international aviation standards',

    'stats.title': 'How we work',
    'stats.platforms': 'Boeing & Airbus platforms',
    'stats.platforms.label': 'Narrow and wide body',
    'stats.response': '24 h',
    'stats.response.label': 'Response to enquiries',
    'stats.reach': 'Worldwide',
    'stats.reach.label': 'Sourcing and delivery',
    'stats.traceability': 'Full',
    'stats.traceability.label': 'Chain of custody',
  ...
  tr: {
    ...
    'hero.eyebrow': 'Havacılık · Uzay · Savunma',
    'hero.cta2': 'Teklif isteyin',
    'hero.credentials': 'Uluslararası havacılık standartlarına göre çalışıyoruz',

    'stats.title': 'Nasıl çalışıyoruz',
    'stats.platforms': 'Boeing & Airbus platformları',
    'stats.platforms.label': 'Dar ve geniş gövde',
    'stats.response': '24 saat',
    'stats.response.label': 'Taleplere dönüş',
    'stats.reach': 'Dünya geneli',
    'stats.reach.label': 'Tedarik ve teslimat',
    'stats.traceability': 'Tam',
    'stats.traceability.label': 'Gözetim zinciri',
